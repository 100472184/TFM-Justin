...
OUT_DIR = Path(r"C:\Users\usuario\TFM-Justin\images")
...
model_data = [
    ("Gemini", 51, 39, 12, 76.5, 11.78),
    ("DeepSeek", 51, 39, 12, 76.5, 11.92),
    ("GLM", 51, 35, 16, 68.6, 16.65),
...
level_success = {
    "DeepSeek":  [69.2, 69.2, 76.9, 91.7],
    "Gemini":   [61.5, 76.9, 76.9, 91.7],
    "GLM":      [38.5, 69.2, 69.2, 100.0],
